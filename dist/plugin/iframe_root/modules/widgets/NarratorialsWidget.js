...
return t.name="NarratorialsWidget",
t.title="Tutorial Narratives",this.DashboardWidget_init(t),this}},
getViewTemplate:{value:function(){
...
}),this.buttonbar.clear().addInput({placeholder:"Search Tutorials",place:"end",
onkeyup:function(e){this.setParam("filter",t(e.target).val())}.bind(this)}))}},
filterNarratives:{value:function(){
var t,e=this.getParam("filter"),a=new RegExp(e,"i")
...
sharingCount:a,filtered:e})}},setInitialState:{value:function(t){
return this.getNarratives({type:"narratorial"}).then(function(t){
